...
const Privacy = (props: Props) => {
  return (
    <main className="container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Smartnote.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Smartnote, accessible from{" "}
            <Link
              href="https://student-hub-omega.vercel.app/"
              className="text-accent hover:text-secondary"
            >
              https://student-hub-omega.vercel.app/
            </Link>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: nabgaisie@outlook.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <Link
              href="https://student-hub-omega.vercel.app/contact"
              className="text-accent hover:text-secondary"
            >
              https://student-hub-omega.vercel.app/contact
            </Link>
          </p>
        </li>
      </ul>
